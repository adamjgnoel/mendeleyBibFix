...
To run the script open a command window and navigate to the folder containing both the bib-file and the executable (e.g., cd "C:\Users\Documents..."); then enter “mendeleyBibFix.exe OUTPUT_FILENAME INPUT_FILENAME” where you specify the input and output filenames. You can omit those filename arguments if your bib-file is called library.bib and you want it to create library_fixed.bib.
